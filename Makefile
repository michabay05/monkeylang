...
ast_test: src/test/ast_test.c src/token.c src/lexer.c src/arena.c src/ast.c src/parser.c
	gcc $(COMP_FLAG) -o bin/ast_test src/test/ast_test.c src/token.c src/lexer.c src/arena.c src/ast.c src/parser.c
